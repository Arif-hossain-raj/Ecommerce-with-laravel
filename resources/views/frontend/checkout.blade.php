            ...
            <div class="card-body">
                ...
                <div class="row checkout-form">
                    ...
                    <div class="col-md-6 mt-3">
                        ...
                        <input type="text" class="form-control" value="{{Auth::user()->city}}"  name="state" placeholder="Enter Your State">
                    </div>
                    <div class="col-md-6 mt-3">
                        <label for="">Country</label>
                        <input type="text" class="form-control" value="{{Auth::user()->country}}"  name="country" placeholder="Enter Country Name">
                    </div>
                    <div class="col-md-6 mt-3">
